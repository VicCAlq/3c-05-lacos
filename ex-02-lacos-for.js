...
for( let inicio = 1; inicio <= final; inicio = inicio +1) {
  acumulador += inicio;
}
...
for (let inicio2 = 1; inicio2 <= final2; inicio2 += 1) {
  if ( inicio2 % 2 != 0 ) {
  acumulador2++;
}
}
export const resposta02 = acumulador2
...
for (let inicio3 = -100; inicio3 <= final3; inicio3 = inicio3 + 1) {
   if ( inicio3 % 2 === 0) {
    acumulador3 += inicio3;
   }
}

export const resposta03 = acumulador3 
...
for (let inicio4 = 1; inicio4 <= final4; inicio4 ++) { 
if (inicio4 % 3 === 0 ) { 
acumulador4 += inicio4
  contador4++
}
...
let mediaA = acumulador4 / contador4;
...
for( let indice5 = 0; indice5 < itensDomesticos.length; indice5 += 1) {
  if(itensDomesticos[indice5].startsWith(letraC)) {
    itensComC.push(itensDomesticos[indice5])
  }
}
...
for(let indice6 = 0; indice6 < itensDomesticos.length; indice6 +=  1) {
if(indice6 % 2 !== 0) {
itensImpares.push(itensDomesticos[indice6])
}
}
...
itensLongos.push(itensDomesticos[indice7])
}
}
...
const itensReversa = [];
let indice8 = itensDomesticos.length - 1

for( let indice8 = itensDomesticos.length - 1; indice8 >= 0; indice8--) {
itensReversa.push(itensDomesticos[indice8]);
}

export const resposta08 = itensReversa
...
for (let indice9 = 0; indice9 < petsExoticos.length; indice9 += 1) {
  petsExoticos[indice9] = petsExoticos[indice9].toUpperCase()
  petsMaiuscula.push(petsExoticos[indice9]);
}

export const resposta09 = petsMaiuscula
...
for (let indice11 = 0; indice11 < petsExoticos.length; indice11 += 1) {
  if ( petsExoticos[indice11].length > 7 ) {
  pets++
}
}

export const resposta11 = pets
